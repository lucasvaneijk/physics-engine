...
if you don't install it via the microsoft store
...
## mac
to install python i am going to show you how to use homebrew but you can also download phython via their site
...
```
if it says that it is not trusted go to 
